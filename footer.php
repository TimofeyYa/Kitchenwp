<footer class="footer">
            ...
            <div class="footer__content">
                <div class="footer__content-wrap">
                    <div class="footer__content-block">
                        <h3>Отдел продаж</h3>
                        <a href="tel:+7 (3852) 463-806">+7 (3852) 463-806, 463-807</a>
                        <address>Алтайский край,<br>
                            г. Барнаул, Малахова, 175д</address>
                    </div>
                    <div class="footer__content-block">
                        <h3>Производство</h3>
                        <a href="tel:+7 (38599) 22-654">+7 (38599) 22-654, 22-768</a>
                        <address>Алтайский край,<br>
                            с. Усть-Калманка, ул. Ленина, 34</address>
                    </div>
                </div>
            
                <div class="footer__content-inst">
                    <a href="#">
                        <p>Мы в Instagram</p>
                ...
                <div class="footer__content-zavod">
                    <a href="#">
                        Сайт создан на <span>ZaVod</span>
                    </a>
                </div>
            </div>
    ...
    <div class="popup" id='popVideo'>
        <div class="popup__content-wrap">
            ...
            <div class="popup__content popup__content-video">
                <iframe src="https://www.youtube.com/embed/kndqIj8Qgok" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
        </div>
    </div>
        ...
        <div class="popup__content-wrap">
            <div class="popup__exit">
                <svg width="27" height="27" viewBox="0 0 27 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect x="2.28809" width="34.9473" height="3.23586" transform="rotate(45 2.28809 0)" fill="white"/>
                    <rect x="27" y="2.28809" width="34.9473" height="3.23586" transform="rotate(135 27 2.28809)" fill="white"/>
                    </svg>
            </div>
    ...
    <script src="JS/serfSlider.js"></script>
</body>
